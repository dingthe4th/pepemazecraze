...
HD_PWD='C:/lab_05b/lab_05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_base_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_base_wrapper.tcl
