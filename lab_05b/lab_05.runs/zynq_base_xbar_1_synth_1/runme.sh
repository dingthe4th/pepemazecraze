...
HD_PWD='D:/lab_05/lab_05.runs/zynq_base_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_base_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_base_xbar_1.tcl
