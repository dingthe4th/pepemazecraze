...
HD_PWD='D:/000 Term 9 000/LBYCPH3/lab_05/lab_05.runs/zynq_base_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_base_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_base_auto_pc_0.tcl
