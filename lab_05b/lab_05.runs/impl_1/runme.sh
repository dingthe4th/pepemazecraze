...
HD_PWD='C:/lab_05b/lab_05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_base_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_base_wrapper.tcl -notrace
