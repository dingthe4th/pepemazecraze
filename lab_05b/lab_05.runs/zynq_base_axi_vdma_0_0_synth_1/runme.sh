...
HD_PWD='D:/lab_05/lab_05.runs/zynq_base_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_base_axi_vdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_base_axi_vdma_0_0.tcl
